...
def parse_args() -> argparse.Namespace:
    # Command-line options for a minimal, reproducible reach training run.
    parser = argparse.ArgumentParser(description="Minimal FrankaReach training with SB3 + HER")
